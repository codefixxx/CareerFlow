  ...
  return (
    <div className="relative pt-32 pb-20 md:pt-48 md:pb-32 flex items-center justify-center text-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(#374151 1px, transparent 1px)', // Replaced #40495c with gray-700 hex
          backgroundSize: '1.5rem 1.5rem',
          opacity: 0.5,
        }}
      ></div>
      {/* Gradient Overlay */}
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-transparent to-gray-900"></div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 max-w-lg mx-auto text-lg text-gray-300 sm:text-xl">
        ...
        <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <a
            ...
            className="w-full sm:w-auto flex items-center justify-center px-8 py-3 border border-gray-600 text-base font-medium rounded-md text-gray-200 bg-gray-800 hover:bg-opacity-80 md:py-4 md:text-lg md:px-10"
          >
            Watch Demo
          </a>
        </div>
